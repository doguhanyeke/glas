...
def run_batch(param, env, instance, controllers):
    ...
    for name, controller in controllers.items():
        ...
        result = np.hstack(
            (param.sim_times[0:step].reshape(-1, 1), states[0:step]))
...
if __name__ == '__main__':
    ...
    if args.batch:
        ...
        model = torch.load(
            '/home/ben/projects/caltech/neural-pid/results/doubleintegrator/exp1Barrier_0/il_current.pt')
